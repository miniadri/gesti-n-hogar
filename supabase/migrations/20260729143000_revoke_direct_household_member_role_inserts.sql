-- Hard-close direct client insert paths for household membership and roles.
-- Trusted flows use server-side service_role after validating auth, household
-- admin status, or an unexpired invite.
