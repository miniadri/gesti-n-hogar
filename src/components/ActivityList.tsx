import { ChevronDown, Clock, Package, ReceiptText, ShoppingCart } from "lucide-react";
...
export function ActivityList({
  ...
  return (
    <Collapsible defaultOpen={defaultOpen}>
      <Card>
        <CollapsibleTrigger className="flex w-full items-center gap-2 p-4 text-left hover:bg-muted/40">
