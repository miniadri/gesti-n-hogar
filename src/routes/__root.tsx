...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HomeSync - Gestión Familiar Inteligente" },
      { name: "description", content: "Sincroniza la compra, finanzas, tareas y domótica de tu hogar en una sola aplicación colaborativa." },
      { name: "author", content: "HomeSync" },
      { name: "theme-color", content: "#3b82f6" },
      { property: "og:title", content: "HomeSync - Gestión Familiar Inteligente" },
      { property: "og:description", content: "Sincroniza la compra, finanzas, tareas y domótica de tu hogar en una sola aplicación colaborativa." },
